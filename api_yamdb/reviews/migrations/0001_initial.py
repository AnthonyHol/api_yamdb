# Generated by Django 2.2.16 on 2022-09-14 14:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True, validators=[reviews.validators.validate_category], verbose_name='Slug категории')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(1, 'Нужна оценка от 1 до 10'), django.core.validators.MaxValueValidator(10, 'Нужна оценка от 1 до 10')], verbose_name='Оценка')),
